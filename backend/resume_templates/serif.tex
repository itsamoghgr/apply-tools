%-------------------------
% Resume Builder shell: "Serif"
%
% A book-like, rule-free look: Palatino-style roman text, centred small-caps
% section headings with no divider line, and slightly airier leading. Reads as
% traditional/academic rather than technical.
%
...
\usepackage{multicol}
\usepackage{setspace}
% newpxtext is a Type1 (not OTF) Palatino clone, so XeTeX resolves it from the
% Tectonic bundle without the font-loading trouble fontawesome5 causes.
...
% Slightly narrower text block than classic — a book-ish measure.
...
% Heading: centred small caps, no \titlerule at all. The empty [] argument is
% what drops the rule the other shells draw.
\titleformat{\section}{
...
\newlength{\sectiongap}\setlength{\sectiongap}{9pt}
\newcommand{\sectionsep}{\par\addvspace{\sectiongap}}

\ifdefined\pdfgentounicode \pdfgentounicode=1 \fi

%-------------------------
% Layout macros — same contract as classic. Entry dates are italic rather than
% bold, which suits the roman face better than the technical look does.
...
\newcommand{\resumeSubheading}[4]{
  \vspace{-2pt}\item
    \begin{tabular*}{1.0\textwidth}[t]{l@{\extracolsep{\fill}}r}
      ...
      \textbf{#1} & \textit{\small #2} \\\fi\else
      \textbf{#1} & \textit{\small #2} \\\fi
...
%----------HEADING----------
\begin{center}
    {\Huge \scshape {{FULL_NAME}}} \\ \vspace{4pt}
    \small {{CONTACT_LINE}}
    \vspace{-8pt}
\end{center}
